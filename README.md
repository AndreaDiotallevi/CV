...
| <p align="center">[Bank](https://github.com/AndreaDiotallevi/bank-python)</p> | A python console application that allows you to make deposits, withdrawals and print your current bank statement<br/>(Personal project of 3 days) | Model classes following OOP principles, with decoupled unit tests | Python | <p align="center">Pytest,<br/>Travis CI<br/><br/>[![Build Status](https://travis-ci.com/AndreaDiotallevi/bank-python.svg?branch=master)](https://travis-ci.com/AndreaDiotallevi/bank-python)[![Test Coverage](https://api.codeclimate.com/v1/badges/65678327fbf59b19d876/test_coverage)](https://codeclimate.com/github/AndreaDiotallevi/bank-python/test_coverage)
