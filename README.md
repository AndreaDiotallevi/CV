...
--- | --- | --- | --- | ---
| <p align='center'>[**ALBUMS MANAGER**](https://github.com/AndreaDiotallevi/albums-manager)</p> | A full-stack web application built with the MERN stack and the LastFM API that lets a user add, view and loan his albums<br/>(Personal project of 1 week) | RESTful APIs, testing API endpoints, connect front-end and back-end via proxy, axios module, URL query string | MongoDB, Express, Node, React, HTML/CSS | <p align="center">Jest, Supertest, Enzyme,<br/>Circle CI, [**Heroku**](https://albums-manager.herokuapp.com)<br/><br/>[![CircleCI](https://circleci.com/gh/AndreaDiotallevi/albums-manager.svg?style=shield)](https://circleci.com/gh/AndreaDiotallevi/albums-manager)<br/>94% Coverage
