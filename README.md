...
[MakersBnB](https://github.com/ajbacon/makers-bnb) | A full-stack application where you can authenticate, list & book spaces and request & refuse requests for a certain date. | Two weeks | Ruby, Sinatra, JavaScript, JQuery, Active Record | RSpec, Capybara
