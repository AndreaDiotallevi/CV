...
| <p align="center">[Bank](https://github.com/AndreaDiotallevi/bank)</p> | A console application that allows you to make deposits, withdrawals and print your current bank statement<br/>(Personal project of 3 days) | Model classes following OOP principles, with decoupled unit tests | Ruby | <p align="center">Rspec,<br/>Travis CI<br/><br/>[![Build Status](https://travis-ci.com/AndreaDiotallevi/bank.svg?branch=master)](https://travis-ci.com/AndreaDiotallevi/bank)[![Test Coverage](https://api.codeclimate.com/v1/badges/6d963be1b71bbea8ad12/test_coverage)](https://codeclimate.com/github/AndreaDiotallevi/bank/test_coverage)</p>
