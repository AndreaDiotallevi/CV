...
--- | --- | --- | --- | ---
[Moovli](https://github.com/AndreaDiotallevi/moovli) | A front-end web application where you can click on any country and get the best movies from that country.<br />(Group project of 2 weeks) | React, NodeJS, Python, HTML / CSS, Heroku | Jest, Enzyme, CircleCI | Handle nested asynchronous requests from multiple APIs within a React application.
