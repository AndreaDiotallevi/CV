...
| Name<img width=50/><img width=50/> | Description<img width=400/><img width=400/> | Main Technical Challenges<img width=200/> | Technologies<img width=100/><img width=100/> | Test Suites<br/>CIs/CDs<img width=750/>
--- | --- | --- | --- | ---
...
| <p align="center">[My Generative Art Website](https://github.com/AndreaDiotallevi/website)</p> | A single page application showcasing my generative art portfolio<br/>(Personal project of 2 years) | Create graphic and interactive experiences with p5.js and deploy a React applications to a custom domain with FTP | React, JavaScript, p5.js, HTML/CSS | <p align="center">Jest, Enzyme,<br/>CircleCI<br/><br/>[![CircleCI](https://circleci.com/gh/AndreaDiotallevi/website.svg?style=shield)](https://circleci.com/gh/AndreaDiotallevi/website)[![Test Coverage](https://api.codeclimate.com/v1/badges/5c59bd9060d52a0a8f65/test_coverage)](https://codeclimate.com/github/AndreaDiotallevi/website/test_coverage)</p>
