...
| Name<img width=50/><img width=50/> | Description<img width=200/><img width=200/> | Technologies<img width=100/><img width=100/> | Test Suites/CIs/CDs<img width=300/><img width=300/> | Main Technical Challenges<img width=600/>
--- | --- | --- | --- | ---
| <p align="center">[Moovli](https://github.com/AndreaDiotallevi/moovli)</p> | A front-end web application where you can click on any country and get the best movies from that country.<br/>(Group project of 2 weeks) | <p align="top">React, NodeJS, Python, HTML</p> / CSS, Heroku | Jest, Enzyme, CircleCI | Handle nested asynchronous requests from multiple APIs within a React application.
...
| <p align="center">[Bank](https://github.com/AndreaDiotallevi/bank)</p> | A console application that allows you to make deposits, withdrawals and print your current bank statement.<br/>(Personal project of 3 days) | Ruby | Rspec, Timecop | Model classes following OOP principles, with decoupled unit tests.
| <p align="center">[MakersBnB](https://github.com/ajbacon/makers-bnb)</p> | A full-stack web application where you can authenticate, list and book spaces, and request and refuse requests, for a certain date.<br/>(Group project of 2 weeks) | Ruby on Sinatra, JavaScript, JQuery, ActiveRecord, HTML / CSS, Heroku | RSpec, Capybara, Travis CI<br/><br/>![Build](https://travis-ci.org/AndreaDiotallevi/expense-tracker.svg?branch=master)<a href="https://codeclimate.com/github/AndreaDiotallevi/expense-tracker/test_coverage"><img src="https://api.codeclimate.com/v1/badges/9797804d6b9a1b0e3c15/test_coverage" /></a> | Write SQL-like queries through an Object-Relational Mapping system like Active Record within a MVC application.
...
| <p align="center">[Expense Tracker](https://github.com/AndreaDiotallevi/expense-tracker)</p> | A full-stack web application where you can manage shared expenses and view credit and debit balances for each member of a theme<br/>(Personal project of 2 weeks) | Design relational database associations and RESTful routes | <p align="center">Ruby on Sinatra, ActiveRecord, HTML/CSS, Heroku</p> | <p align="center">RSpec, Capybara, Travis CI<br/><br/>![Build](https://travis-ci.org/AndreaDiotallevi/expense-tracker.svg?branch=master)<a href="https://codeclimate.com/github/AndreaDiotallevi/expense-tracker/test_coverage"><img src="https://api.codeclimate.com/v1/badges/9797804d6b9a1b0e3c15/test_coverage" /></a></p>
| <p align="center">[Bank](https://github.com/AndreaDiotallevi/bank)</p> | A console application that allows you to make deposits, withdrawals and print your current bank statement<br/>(Personal project of 3 days) | Model classes following OOP principles, with decoupled unit tests | <p align="center">Ruby</p> | <p align="center">Rspec,<br/>Travis CI<br/><br/>![Build](https://travis-ci.com/AndreaDiotallevi/bank.svg?branch=master)<a href="https://codeclimate.com/github/AndreaDiotallevi/bank/test_coverage"><img src="https://api.codeclimate.com/v1/badges/6d963be1b71bbea8ad12/test_coverage" /></a></p>
